...
data class SmartTakeProfitConfig(
    ...
    var liquidityDangerRatio: BigDecimal = BigDecimal("0.3"),
    ...
    var liquidityWarningRatio: BigDecimal = BigDecimal("1.0"),
